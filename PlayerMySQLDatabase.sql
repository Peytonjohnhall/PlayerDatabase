...
/*
Fantasy Football MySQL/PostgreSQL Database.
...
CREATE TABLE Teams (
    ...
    Team_Stadium_Name VARCHAR(50) NOT NULL,
    Team_Stadium_DMS_Coordinates VARCHAR(26) NOT NULL
);

CREATE TABLE Coaches (
    Coach_Name VARCHAR(50) PRIMARY KEY,
    Coach_Team VARCHAR(10) NOT NULL, -- Foreign key
    Coach_Age INT NOT NULL,
    Coach_Record VARCHAR(20) NOT NULL,
    Coach_Super_Bowl_Wins INT NOT NULL,
    CONSTRAINT fk_Coach_Team
    	FOREIGN KEY (Coach_Team) REFERENCES Teams(Team_Name)
);

CREATE TABLE Players (
    Player_Fantasy_SQL_ID INT PRIMARY KEY,
    ...
    Player_Team VARCHAR(10) NOT NULL, -- Foreign key
    Player_College VARCHAR(100) NOT NULL,
    Player_Position VARCHAR(10) NOT NULL, 
    Player_Super_Bowl_Rings INT NOT NULL,
    Player_Injury_History VARCHAR(100),
    Player_Nicknames VARCHAR(100),
